...
const getEventos = async (page,pageSize,searchName) => {
  try {
    ...
    const response = await fetch(`http://3.220.179.149/api/api/eventos/listareventos?permission=Gestion%de%Eventos&query=${searchName}&page=${page}&pageSize=${pageSize}`, {
      method: 'GET',
      headers: {
