  ...
  useEffect(() => {
    ...
    async function loadCuponData(searchTerm,searchTermTipoCupones,searchTienda) {
      ...
      try {
        ...
        // Simulación de carga
        let response="";
        response = await fetch(apiUrl + `/api/client/listarClientesActivos?page=1&pageSize=10`, {
          method: 'POST',
        ...
        response = await fetch(apiUrl + `/api/client/listarCuponesXClientes?idParam=${idParam}&endDate=${endDateParamBarra}&startDate=${startDateParamBarra}`, {
          method: 'GET',
        ...
        response = await fetch(apiUrl + `/api/client/listarCuponesCanjeadosUsados?idParam=${idParam}&endDate=${endDateParam}&startDate=${startDateParam}`, {
          method: 'GET',
  ...
  useEffect(() => {
    ...
    async function loadDashEventonCateg(searchTerm, searchTermTipoCupones) {
      try {
        ...
        responseEventoCateg = await fetch(apiUrl + `/api/client/listarEventosCategoria?idParam=${idParam}&endDate=${endDateParamEvento}&startDate=${startDateParamEvento}`, {
          method: 'GET',
  ...
  useEffect(() => {
    ...
    async function loadDashCuponCateg(searchTerm, searchTermTipoCupones) {
      try {
        ...
        responseCuponCateg = await fetch(apiUrl + `/api/client/listarCuponesCategoriaRadar?idParam=${idParam}&endDate=${endDateParam}&startDate=${startDateParam}`, {
          method: 'GET',
  ...
  useEffect(() => {
    ...
    async function loadTableData(searchTerm, searchTermTipoCupones) {
      try {
        ...
        if(searchName===""){
          responseTable = await fetch(apiUrl + `/api/client/listarcuponesxcliente?permission=Gestion%de%Cupones&query=all&idParam=${idParam}&page=${page}&pageSize=${pageSize}&endDate=${endDateParam}&startDate=${startDateParam}&endDateExp=${endDateParamExp}&startDateExp=${startDateParamExp}&idTienda=${selectedTienda}&idCategoriaTienda=${selectedCategoria}`, {
            method: 'GET',
