...
export default function TiendaDetail() {
  ...
  useEffect(() => {
    ...
    async function loadTiendaData(searchTerm,searchTermTipoCupones) {
      ...
      try {
        ...
        // Simulación de carga
        let response="";
        response = await fetch(`http://3.218.68.113/api/api/tiendas/detalleTiendaCompleto`, {
          method: 'POST',
        ...
        response = await fetch(`http://3.218.68.113/api/api/tiendas/listarCuponesMesxTienda?idParam=${idParam}&endDate=${endDateParam}&startDate=${startDateParam}`, {
          method: 'GET',
        ...
        if(searchName===""){
          response = await fetch(`http://3.218.68.113/api/api/tiendas/listarcuponesxtienda?query=all&idParam=${idParam}&page=${page}&pageSize=${pageSize}`, {
            method: 'GET',
          ...
          response = await fetch(`http://3.218.68.113/api/api/tiendas/listarcuponesxtienda?query=${searchName}&idParam=${idParam}&page=${page}&pageSize=${pageSize}`, {
            method: 'GET',
  ...
  const handleDescargarQR = async (event) => {
    ...
    try {
      ...
      let response="";
      response = await fetch(`http://3.218.68.113/api/api/qr/generar`, {
        method: 'POST',
