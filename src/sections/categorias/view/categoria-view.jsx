...
import CategoriaTableToolbar from '../categoria-table-toolbar';
  ...
  useEffect(() => {
    ...
    const handleDeshabilitar = async () => {
     try {
        const response = await fetch('http://3.220.179.149/api/api/categoriaTienda/deshabilitarCategoriaTiendaWeb', {
          method: 'POST',
          headers: {
    ...
    try {
        const response = await fetch('http://3.220.179.149/api/api/categoriaTienda/habilitarCategoriaTiendaWeb', {
          method: 'POST',
          headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
    ...
    const handleCrear = async () => {
      try {
        const response = await fetch('http://3.220.179.149/api/api/categoriaTienda/crearCategoriaTiendaWeb', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json'
