...
export async function getTipoCupones(token, refreshToken, searchTermTipoCupones) {
  try {
    ...
    if(searchTermTipoCupones==="" || searchTermTipoCupones === undefined){
      response = await fetch(`http://3.218.68.113/api/api/tipocupones/listartipocupones?query=all&page=1&pageSize=10`, {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
          'Authorization': `Bearer ${token}`,
      ...
      response = await fetch(`http://3.218.68.113/api/api/tipocupones/listartipocupones?query=${searchTermTipoCupones}&page=1&pageSize=10`, {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
          'Authorization': `Bearer ${token}`,
...
export async function getCategoriaTiendas(token, refreshToken, searchTerm) {
  try {
    ...
    if(searchTerm==="" || searchTerm === undefined){
      ...
      response = await fetch(`http://3.218.68.113/api/api/categoriaTienda/listarCategoriaTiendasWeb?query=${searchTerm}&page=1&pageSize=10`, {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
          'Authorization': `Bearer ${token}`,
...
export async function getLugarEvento(token, refreshToken, searchTerm) {
  try {
    ...
    if(searchTerm==="" || searchTerm===undefined ){
      ...
      response = await fetch(`http://3.218.68.113/api/api/lugares/listarLugares?query=${searchTerm}&page=1&pageSize=10`, {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
          'Authorization': `Bearer ${token}`,
